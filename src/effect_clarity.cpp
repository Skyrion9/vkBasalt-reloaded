...
#define SPEC(id, field) \
    .specId = (id), .specOffset = offsetof(ClaritySpecData, field), .specSize = sizeof(((ClaritySpecData*) 0)->field)
        ...
        VkColorSpaceKHR colorSpace)
    {
        ...
        mapEntries.push_back(
            {.constantID = 65535, .offset = offsetof(ClaritySpecData, colorSpaceMode), .size = sizeof(int32_t)});
    ...
    const std::vector<EffectParamDesc>& ClarityEffect::getParamDescs() const
    {
        static const std::vector<EffectParamDesc> params = {
            {.key        = "clarityStrength",
             ...
             .step       = 0.1,
             .category   = "Sharpening",
             .tooltip    = "Master strength of the bilateral sharpening pass. Controls how strongly the macro-contrast "
                           "delta is applied. Default 1.0.",
             SPEC(2, strength)},
            ...
            {.key        = "clarityRadius",
             ...
             .step       = 1.0,
             .category   = "Sharpening",
             .tooltip    = "Radius of the bilateral contrast kernel. Larger = boosts wider features. Smaller = fine "
                           "detail only. Default 2.0.",
             SPEC(0, radius)},
            ...
            {.key        = "clarityEdgeThreshLow",
             ...
             .step       = 0.01,
             .category   = "Protection",
             .tooltip = "Lower edge threshold. Contrast differences below this are fully suppressed. Lower = more fine "
                        "detail passes through. Default 0.05.",
             SPEC(6, edgeThreshLow)},

            {.key        = "clarityEdgeThreshHigh",
             ...
             .step       = 0.01,
             .category   = "Protection",
             .tooltip    = "Upper edge threshold. Contrast differences above this are fully passed through. The "
                           "Low-to-High range is the smooth transition zone. Default 0.25.",
             SPEC(7, edgeThreshHigh)},

            {.key        = "clarityEnableDithering",
             ...
             .category   = "Dithering",
             .tooltip =
                 "Applies dithering after sharpening to break up banding introduced by the contrast boost. Default on.",
