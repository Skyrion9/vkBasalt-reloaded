            ...
            {"antitaa",
             {
                 ...
                 {"crystalclearBandPassWidth", 1.17},
                 {"crystalclearEdgeThreshLow", 0.026},
                 {"crystalclearEdgeThreshHigh", 0.26},
            ...
            {"artifactless",
             {
                 ...
                 {"crystalclearShimmerReduction", 0.8},
                 {"crystalclearBandPassWidth", 0.78},
                 {"crystalclearEdgeThreshLow", 0.065},
                 {"crystalclearEdgeThreshHigh", 0.455},
            ...
            {"maxsharp",
             {
                 ...
                 {"crystalclearBandPassWidth", 1.56},
                 {"crystalclearEdgeThreshLow", 0.026},
                 {"crystalclearEdgeThreshHigh", 0.26},
