...
```ini
# CrystalClear: All-in-one HDR-aware AA, Macro/Micro Contrast, and Film Grain to combat TAA and bland visuals.
# -- Core & AA Toggles --
...
crystalclearFxaaSubpixAmount = 0.75
...
# Vibrance: Non-linear saturation boost. Boosts less saturated colors more than already saturated ones.
# Preserves luma (brightness). 0.0 = off, 0.5 = noticeable pop, 1.0 = max. Negative values desaturate.
crystalclearVibrance = 0.0
# -- Debanding --
# EnableDeband: Breaks up color banding in flat/gradient areas (skies, fog, shadows).
crystalclearEnableDeband = 0
# DebandStrength: Intensity of the debanding. (0.0=off, 1.0=max)
crystalclearDebandStrength = 0.5
# -- Tone Curve --
# ToneCurve: Filmic highlight rolloff. Softly compresses bright highlights to prevent
# harsh clipping and add a filmic shoulder. (0.0=off, 1.0=max)
crystalclearToneCurve = 0
# -- Chroma Smoothing (Color Denoise) --
# EnableChromaSmooth: Blurs only chroma channels in flat areas to kill color noise
# from TAA/compression without softening luma detail.
crystalclearEnableChromaSmooth = 0
# ChromaSmoothStrength: Intensity of chroma smoothing. (0.0=off, 0.5=balanced, 1.0=max)
crystalclearChromaSmoothStrength = 0.5
# -- Specular Desaturation --
# SpecularDesat: Desaturates extreme specular highlights toward white, mimicking real
# lens behavior. Prevents "neon" highlights. (0.0=off, 0.4=subtle, 1.0=max)
crystalclearSpecularDesat = 0.0
